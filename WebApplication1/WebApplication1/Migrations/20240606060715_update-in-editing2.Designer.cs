...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20240606060715_update-in-editing2")]
    partial class updateinediting2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApplication1.Models.Guest", b =>
                {
                    b.HasOne("WebApplication1.Models.Booking", "Booking")
                        .WithOne()
                        .HasForeignKey("WebApplication1.Models.Guest", "BookingId")
                    ...
                    b.HasOne("WebApplication1.Models.Room", "Room")
                        .WithOne()
                        .HasForeignKey("WebApplication1.Models.Guest", "RoomId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
